...
| 3 | TID and CID lookups return structured rows and extensibility metadata. | In progress | Python resolvers now return structured TID and CID rows with extensibility metadata; CLI and MCP exposure remain pending before completion. |

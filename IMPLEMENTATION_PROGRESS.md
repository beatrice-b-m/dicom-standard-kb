...
| Phase 9 - V2 release hardening | Complete | Remediation replaced the earlier false-positive integration evidence with a strict release gate. The rebuilt official 2026b KB now imports PS3.5 VR rows, PS3.18 media/DICOMweb rows, and PS3.16 SR template/context group/coded-concept rows; `make test-dicom-release` passes the strict prerequisite and pinned v2 goldens, including the post-review PS3.18 Store/WADO/STOW workflow examples. |
...
| Commit-ready summary | Pending current remediation commit adds strict release goldens for the post-review PS3.18 Store/WADO/STOW workflow examples. |
